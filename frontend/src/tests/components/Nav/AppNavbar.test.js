...
describe('AppNavbar tests', () => {
  ...
  test('renders correctly for regular logged in user', async () => {
    ...
    await waitFor(() =>
      expect(getByText('Welcome, pconrad.cis@gmail.com')).toBeInTheDocument()
    );
  });
  ...
  test('renders correctly for admin user', async () => {
    ...
    await waitFor(() =>
      expect(getByText('Welcome, phtcon@ucsb.edu')).toBeInTheDocument()
    );
  ...
  test('renders the todos menu correctly', async () => {
    ...
    await waitFor(() =>
      expect(getByTestId('appnavbar-todos-dropdown')).toBeInTheDocument()
    );
  });
  ...
  test('renders the AppNavbarLocalhost when on http://localhost:3000', async () => {
    ...
    await waitFor(() =>
      expect(getByTestId('AppNavbarLocalhost')).toBeInTheDocument()
    );
  });
  ...
  test('renders the ucsbdates menu correctly for a user', async () => {
    ...
    await waitFor(() =>
      expect(getByTestId('appnavbar-ucsbdates-dropdown')).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId('appnavbar-ucsbdates-list')).toBeInTheDocument()
    );
  });
  ...
  test('renders the ucsbdates menu correctly for an admin', async () => {
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-ucsbdates-create/)).toBeInTheDocument()
    );
  });
  ...
  test('renders the Students menu correctly for a user', async () => {
    ...
    await waitFor(() =>
      expect(getByTestId('appnavbar-students-dropdown')).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId('appnavbar-students-list')).toBeInTheDocument()
    );
  });
  ...
  test('renders the Students menu correctly for an admin', async () => {
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-students-create/)).toBeInTheDocument()
    );
  });
  ...
  test('renders the ucsbSubjects menu correctly for a user', async () => {
    ...
    await waitFor(() =>
      expect(getByTestId('appnavbar-ucsbsubjects-dropdown')).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId('appnavbar-ucsbsubjects-list')).toBeInTheDocument()
    );
  });
  ...
  test('renders the ucsbSubjects menu correctly for an admin', async () => {
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-ucsbsubjects-create/)).toBeInTheDocument()
    );
  });
  ...
  test('renders the earthquakes menu correctly for a user', async () => {
    ...
    await waitFor(() =>
      expect(getByTestId('appnavbar-earthquakes-dropdown')).toBeInTheDocument()
    );
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId('appnavbar-earthquakes-list')).toBeInTheDocument()
    );
  });
...
test("renders the collegiatesubreddits menu correctly for an admin", async () => {
  ...
  test('renders the earthquakes menu correctly for an admin', async () => {
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-earthquakes-retrieve/)).toBeInTheDocument()
    );
  });
});
